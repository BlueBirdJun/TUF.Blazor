...
//using TUF.Infrastructure.Common.Events;
...
namespace TUF.Infrastructure.Identity.Roles;
...
internal class RoleService : IRoleService
{
    ...
    Task<Application.Identity.Roles.RoleDto> IRoleService.GetByIdAsync(string id)
    {
        throw new NotImplementedException();
    }

    Task<Application.Identity.Roles.RoleDto> IRoleService.GetByIdWithPermissionsAsync(string roleId, CancellationToken cancellationToken)
    {
        throw new NotImplementedException();
    }
